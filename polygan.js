...
const polygansends = async (req, res, next) => {
  ...
  await polygansend(myAddress, privateKey, receiver, amount)
    .then(async (r) => {
...
async function polygansend(myAddress, privateKey, receiver, amount) {
...
const polyganbalance = async (req, res, next) => {
    let myAddress = req.body.myAddress;
